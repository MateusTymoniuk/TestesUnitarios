...
public class CalculoValorLocacaoTest {
	...
	static Filme filme1 = new Filme("Filme 1", 1, 4.0);
	static Filme filme2 = new Filme("Filme 2", 1, 4.0);
	static Filme filme3 = new Filme("Filme 3", 1, 4.0);
	static Filme filme4 = new Filme("Filme 4", 1, 4.0);
	static Filme filme5 = new Filme("Filme 5", 1, 4.0);
	static Filme filme6 = new Filme("Filme 6", 1, 4.0);
	static Filme filme7 = new Filme("Filme 7", 1, 4.0);
